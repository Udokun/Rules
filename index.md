...
1. Любой отыгрыш эротическо-порнографического характера (ERP) на данном сервере запрещен. К ERP относятся:
   - Детализированные описания интимных действий персонажей.
   - Явные или завуалированные намеки на половую близость.
   - Развитие романтических отношений между персонажами, включая флирт.
   - Использование игровых механик для имитации эротического или романтического взаимодействия.
